...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CustomWrapper", function() { return CustomWrapper; });
var View = 'view';
var Icon = 'icon';
...
function hydrate(node) {
  ...
  if (!node.isAnyEventBinded()) {
    if (node.nodeName === 'view') {
      var isExtractProp = Object.keys(props).find(function (prop) {
    ...
    value: function removeChild(child, isReplace) {
      ...
      if (isReplace !== true) {
        this.enqueueUpdate({
          ...
          value: function value() {
            return _this4.childNodes.map(hydrate);
          }
        });
      }
  ...
  Object(_Users_sulei_Desktop_study_applets_node_modules_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_11__[/* default */ "a"])(TaroRootElement, [{
    ...
    value: function performUpdate() {
      ...
      setTimeout(function () {
        ...
        (_a = CurrentReconciler.prepareUpdateData) === null || _a === void 0 ? void 0 : _a.call(CurrentReconciler, data, _this15);

        if (initRender) {
          (_b = CurrentReconciler.appendInitialPage) === null || _b === void 0 ? void 0 : _b.call(CurrentReconciler, data, _this15);
        }
        ...
        if (isFunction(prerender)) {
          ...
          if (!initRender) {
            for (var p in data) {
              ...
              for (var i = dataPathArr.length; i > 0; i--) {
                ...
                var getData = get(ctx.__data__, allPath);
          ...
          if (updateArrLen) {
            var eventId = "".concat(_this15._path, "_update_").concat(incrementId());
            var executeTime = 0;
  ...
  Object(_Users_sulei_Desktop_study_applets_node_modules_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_11__[/* default */ "a"])(TaroDocument, [{
    ...
    value: function getElementsByTagName(tagName) {
      ...
      eventSource.forEach(function (node) {
        ...
        if (node.nodeName === tagName || tagName === '*' && node !== _this16) {
          elements.push(node);
        }
      });
      return elements;
