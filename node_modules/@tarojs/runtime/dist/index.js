...
function hydrate(node) {
    ...
    if (!node.isAnyEventBinded()) {
        ...
        if (node.nodeName === 'text') {
            data["nn" /* NodeName */] = 'static-text';
        }
        if (node.nodeName === 'image') {
            data["nn" /* NodeName */] = 'static-image';
        }
    }
    ...
    TaroRootElement.prototype.performUpdate = function performUpdate (initRender, prerender) {
        ...
        setTimeout(function () {
            ...
            if (isFunction(prerender)) {
                ...
                if (updateArrLen) {
                    var eventId = (this$1._path) + "_update_" + (incrementId());
                    var executeTime = 0;
