...
const TabbarItem = (props) => {
    ...
    const className = index$1.classNames('weui-tabbar__item', {
    ...
    return core.h("a", { key: index, href: 'javascript:;', class: className, onClick: onClick },
        core.h("span", { style: { display: 'inline-block', position: 'relative' } },
            core.h("img", { src: iconPath, alt: '', class: 'weui-tabbar__icon' }),
            badgeText &&
                core.h("span", { class: 'weui-badge taro-tabbar-badge', style: badgeStyle }, badgeText),
            showRedDot &&
                core.h("span", { class: 'weui-badge weui-badge_dot', style: dotStyle })),
        core.h("p", { class: 'weui-tabbar__label', style: { color: textColor } }, text));
};
...
const Tabbar = class {
    constructor(hostRef) {
        ...
        this.list = list;
        this.onLongPress = core.createEvent(this, "longpress", 7);
    }
    getCurrentUrl() {
    ...
    render() {
        ...
        const containerCls = index$1.classNames('weui-tabbar', {
        ...
        return (core.h(core.Host, { class: index$1.classNames(basicTabBarClassName, `${basicTabBarClassName}-${tabbarPos}`, {
                [hideTabBarClassName]: shouldHideTabBar,
                [hideTabBarWithAnimationClassName]: shouldSlideout
            }) }, core.h("div", { class: containerCls, style: {
            ...
            return (core.h(TabbarItem, { index: index, onSelect: this.switchTab.bind(this), isSelected: isSelected, textColor: textColor, iconPath: iconPath, text: item.text, badgeText: item.badgeText, showRedDot: item.showRedDot }));
        }))));
    }
    get tabbar() { return core.getElement(this); }
