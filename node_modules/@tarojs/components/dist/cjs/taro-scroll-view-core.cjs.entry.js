...
const ScrollView = class {
    constructor(hostRef) {
        ...
        this.onScroll = core.createEvent(this, "scroll", 7);
        this.onScrollToUpper = core.createEvent(this, "scrolltoupper", 7);
        this.onScrollToLower = core.createEvent(this, "scrolltolower", 7);
    }
    ...
    render() {
        ...
        return (core.h(core.Host, { class: cls, onScroll: this.handleScroll }, core.h("slot", null)));
    }
