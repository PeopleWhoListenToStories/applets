...
const PullToRefresh = class {
    constructor(hostRef) {
        ...
        this.onRefresh = core.createEvent(this, "refresh", 7);
    }
    get scrollContainer() {
    ...
    render() {
        const renderRefresh = (cls) => {
            ...
            return (core.h("div", { class: `${prefixCls}-content-wrapper` }, core.h("div", { class: cla, ref: el => {
                    this.contentRef = el;
                } }, showIndicator && (core.h("div", { class: `${prefixCls}-indicator` }, core.h("div", null), core.h("div", null), core.h("div", null))), core.h("slot", null))));
        };
        if (this.scrollContainer) {
            return renderRefresh(`${this.prefixCls}-content ${this.prefixCls}-down`);
        }
        return (core.h(core.Host, { class: index$1.classNames(this.prefixCls, `${this.prefixCls}-down`) }, renderRefresh(`${this.prefixCls}-content`)));
    }
