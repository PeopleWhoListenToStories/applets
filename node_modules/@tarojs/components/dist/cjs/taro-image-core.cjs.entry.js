...
new Promise(function (resolve) { resolve(require('./intersection-observer-dc4cfcef.js')); });
const Image = class {
    constructor(hostRef) {
        ...
        this.onLoad = core.createEvent(this, "load", 7);
    ...
    render() {
        ...
        return (core.h(core.Host, { class: cls }, lazyLoad ? (core.h("img", { ref: img => (this.imgRef = img), class: imgCls, onLoad: imageOnLoad.bind(this), onError: imageOnError.bind(this) })) : (core.h("img", { ref: img => (this.imgRef = img), class: imgCls, src: src, onLoad: imageOnLoad.bind(this), onError: imageOnError.bind(this) }))));
    }
