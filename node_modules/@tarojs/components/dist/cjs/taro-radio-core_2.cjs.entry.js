...
const Radio = class {
    ...
    render() {
        ...
        return (core.h(core.Host, { className: 'weui-cells_checkbox', onClick: this.handleClick }, core.h("input", { ref: dom => {
            ...
            }, type: 'radio', name: name, value: value, class: 'weui-check', checked: checked, disabled: disabled, onChange: e => e.stopPropagation() }), core.h("i", { class: 'weui-icon-checked' }), core.h("slot", null)));
    }
