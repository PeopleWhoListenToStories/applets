...
const Slider = class {
    constructor(hostRef) {
        ...
        this.onChanging = core.createEvent(this, "changing", 7);
    }
    function(newVal) {
        const { max, min } = this;
    ...
    render() {
        ...
        return (core.h(core.Host, { class: 'weui-slider-box' }, core.h("div", { class: 'weui-slider' }, core.h("div", { class: 'weui-slider__inner', style: innerStyles, ref: c => (this.sliderInsRef = c) }, core.h("div", { style: trackStyles, class: 'weui-slider__track' }), core.h("div", { class: 'weui-slider__handler', ref: dom => {
                if (dom)
                    this.handler = dom;
            }, style: handlerStyles }), core.h("input", { type: 'hidden', name: name, value: val }))), showValue && core.h("div", { class: 'weui-slider-box__value' }, val)));
    }
...
exports.taro_slider_core = Slider;
