import { r as registerInstance, c as createEvent, h, H as Host } from './core-f216d924.js';
...
var Image = /** @class */ (function () {
    ...
    Image.prototype.render = function () {
        ...
        var imgCls = classNames("taro-img__mode-" + mode.toLowerCase().replace(/\s/g, ''), (_a = {},
            _a["taro-img__mode-aspectfill--" + aspectFillMode] = mode === 'aspectFill',
            _a));
        return (h(Host, { class: cls }, lazyLoad ? (h("img", { ref: function (img) { return (_this.imgRef = img); }, class: imgCls, onLoad: imageOnLoad.bind(this), onError: imageOnError.bind(this) })) : (h("img", { ref: function (img) { return (_this.imgRef = img); }, class: imgCls, src: src, onLoad: imageOnLoad.bind(this), onError: imageOnError.bind(this) }))));
    };
