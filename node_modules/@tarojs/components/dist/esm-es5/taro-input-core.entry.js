...
var Input = /** @class */ (function () {
    function Input(hostRef) {
        ...
        this.hanldeInput = function (e) {
            e.stopPropagation();
            var _a = _this, type = _a.type, maxlength = _a.maxlength, confirmType = _a.confirmType, password = _a.password;
    ...
    Input.prototype.render = function () {
        var _this = this;
        var _a = this, value = _a.value, type = _a.type, password = _a.password, placeholder = _a.placeholder, disabled = _a.disabled, maxlength = _a.maxlength, autoFocus = _a.autoFocus, confirmType = _a.confirmType, name = _a.name;
        return (h("input", { ref: function (input) {
    ...
    Object.defineProperty(Input, "style", {
        get: function () { return "input,taro-input-core{display:block}input{height:1.4rem;text-align:inherit;text-overflow:clip;overflow:hidden;white-space:nowrap}"; },
        enumerable: true,
        configurable: true
    });
    return Input;
