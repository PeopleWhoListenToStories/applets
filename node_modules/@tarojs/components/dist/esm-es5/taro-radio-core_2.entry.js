...
var Radio = /** @class */ (function () {
    ...
    Radio.prototype.render = function () {
        var _this = this;
        var _a = this, checked = _a.checked, name = _a.name, value = _a.value, disabled = _a.disabled;
        return (h(Host, { className: 'weui-cells_checkbox', onClick: this.handleClick }, h("input", { ref: function (dom) {
            ...
            }, type: 'radio', name: name, value: value, class: 'weui-check', checked: checked, disabled: disabled, onChange: function (e) { return e.stopPropagation(); } }), h("i", { class: 'weui-icon-checked' }), h("slot", null)));
    };
