import { h, r as registerInstance, c as createEvent, H as Host, g as getElement } from './core-f216d924.js';
...
var TabbarItem = function (props) {
    ...
    var className = classNames('weui-tabbar__item', {
    ...
    return h("a", { key: index, href: 'javascript:;', class: className, onClick: onClick }, h("span", { style: { display: 'inline-block', position: 'relative' } }, h("img", { src: iconPath, alt: '', class: 'weui-tabbar__icon' }), badgeText &&
        h("span", { class: 'weui-badge taro-tabbar-badge', style: badgeStyle }, badgeText), showRedDot &&
        h("span", { class: 'weui-badge weui-badge_dot', style: dotStyle })), h("p", { class: 'weui-tabbar__label', style: { color: textColor } }, text));
};
...
var Tabbar = /** @class */ (function () {
    ...
    Tabbar.prototype.render = function () {
        ...
        var containerCls = classNames('weui-tabbar', (_a = {},
        ...
        return (h(Host, { class: classNames(basicTabBarClassName, basicTabBarClassName + "-" + tabbarPos, (_b = {},
                _b[hideTabBarClassName] = shouldHideTabBar,
                _b[hideTabBarWithAnimationClassName] = shouldSlideout,
                _b)) }, h("div", { class: containerCls, style: {
            ...
            return (h(TabbarItem, { index: index, onSelect: _this.switchTab.bind(_this), isSelected: isSelected, textColor: textColor, iconPath: iconPath, text: item.text, badgeText: item.badgeText, showRedDot: item.showRedDot }));
        }))));
    };
